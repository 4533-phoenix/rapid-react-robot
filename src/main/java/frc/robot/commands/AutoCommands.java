...
public class AutoCommands {
  ...
  public static Command angularTurnAutoCommand(
    double speed,
    double angle,
    Direction direction
  ) {
  ...
  public static Command curveTurnAutoCommand(
    double left,
    double right,
    Direction direction
  ) {
  ...
  public static Command circleTurnAutoCommand(
    double speed,
    double angle,
    Direction direction,
    double radius
  ...
  public static Command oldDriveDistanceAutoCommand(
    double distance,
    Direction direction
  ) {
    return new FunctionalCommand(
  ...
  public static Command oldAngularTurnAutoCommand(
    double speed,
    double angle,
    Direction direction
  ) {
  ...
  public static Command stopDriveCommand() {
    return new InstantCommand(() -> Robot.drive.tank(0, 0), Robot.drive);
  }
